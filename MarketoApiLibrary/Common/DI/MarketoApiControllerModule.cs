...
namespace MarketoApiLibrary.Common.DI
{
    public class MarketoApiControllerModule : IMarketoApiModule
    {
        public void Initialize(IMarketoApiContainer container)
        {
            ...
            container.RegisterType<ISmartListsRequestFactory, SmartListsRequestFactory>(RegistrationLifetime
                .InstancePerThread);
            ...
            container.RegisterType<IHttpRequestProvider<GetSmartListsRequest>, GetSmartListsRequestProvider>(
                RegistrationLifetime.InstancePerThread);
            container.RegisterType<IConfigurationProvider, ConfigurationProvider2>(RegistrationLifetime
                .InstancePerThread);
            container.RegisterType<ILoggingService<CommerceLog>, CommerceLogService>(RegistrationLifetime
                .InstancePerThread);
            container.RegisterType<ILoggingService<SynchronizationLog>, SynchronizationLogService>(RegistrationLifetime
                .InstancePerThread);
